...
void CMainWindow::InitSettings(HMENU hMenu)
{
    ...
    CheckMenuRadioItem(hMenu, DEPTH_FILTER_FIRST, DEPTH_FILTER_LAST, IDM_DEPTH_FILTER_CANNYEDGE, MF_BYCOMMAND);
}
...
wstring CMainWindow::ContourNumberToString(int number)
{
	wostringstream stream;
	stream << number;
	return _TEXT("Contours: ") + stream.str();
}
